/* ============================================================
   Umbra — shared risk-scoring engine
   Loaded by the dashboard, the popup, and the service worker.
   Defines a single global: `Audit`.
   No network calls — every score is computed locally from the
   data Chrome's `chrome.management` API already exposes.
   ============================================================ */
(function (global) {
  "use strict";
